module Myst
  class Interpreter
    ...
    NativeLib.passthrough(ENV.delete(key : String), return_nil: true)
    ...
    NativeLib.method(:env_fetch, TModule, key : String, default : String) do
    ...
    def init_env
      ...
      NativeLib.def_method(env_module, :delete,   :passthrough_ENV_delete)
