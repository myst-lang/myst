module Myst
  class VM
    ...
    # Standard interface for running a parsed program. Using this interface
    # ensures that every program goes through the proper phases of
    # interpretation (semantic analysis, interpretation, etc.).
    def run(program : Node)
      @semantic_visitor.visit(program)
