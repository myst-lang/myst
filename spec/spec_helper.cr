...
def run_program(source : String) : Tuple(IO, IO)
  program = parse_program
  interpreter = Myst::Interpreter.new
  output = IO::Memory.new
  errput = IO::Memory.new # TODO: support capturing errput.
  program.accept(interpreter, output)
