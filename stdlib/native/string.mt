...
deftype String
  ...
  def to_i(base : Integer) : Integer; end
  #doc to_i -> integer
  ...
  #| resulting list.
  def split(delimiter : String) : List; end
  #doc split -> list
  ...
  def chomp(suffix : String) : String; end
  #doc chomp -> string
  ...
  def at(index : Integer, length : Integer) : String; end
